...
const Transactions = () => {
  return (
    <div className="w-[50%] flex flex-col p-10 mb-10 bg-white rounded-xl gap-6">
      ...
      <div className="flex flex-col justify-between">
        ...
        <div className="flex flex-row justify-between border-b-1 pb-5 items-center">
          ...
          <div>
            <p className="text-xl">0.86700 BTC</p>
            <p className="text-slate-500 text-sm">$ 6,739.84</p>
          </div>
          <p className="text-xl text-red-500">Failed</p>
        </div>
